    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" method="post" action="{{ route('account/profile-edit') }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-xs-12">
                            <input type="file" name="form[thumb]" class="form-control file-upload-info"  placeholder="Upload Image">
                        </div>
                    </div>
